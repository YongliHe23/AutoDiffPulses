...
def err_l2z_sgd(Mr_: Tensor, Md_: Tensor,batch_if:Optional[int]=1,seed:Optional[int]=10,w_: Optional[Tensor] = None) -> Tensor:
    """
    *INPUTS*
    - `Mr_` (1, nM, xyz)
    - `Md_` (1, nM, xyz) 
    ...
    *OUTPUTS*
    ...
    sample_idx=torch.randperm(Me_.numel(),generator=torch.random.manual_seed(seed))[:batchsize]
